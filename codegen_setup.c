...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Fear Effect",
    .project_root_env = "FEAR_EFFECT_PROJECT_ROOT",
    .build_dir_env = "FEAR_EFFECT_BUILD_DIR",
    .force_setup_env = "FEAR_EFFECT_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SLUS_009.20_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Fear_Effect_Recompiled",
    .prepare_note =
